...
const productImages = importAll(require.context('./assets/products', false, /\.(png|jpe?g|svg)$/));
...
<>
  ...
  <main>
    <section id="home" className="container greeting-section">
      ...
      <div className="right-side">
        ...
        <div className="local-time">
          <div className="time-holder">
            <span data-time="hours" className="time-number">
              08
            </span>
            <span className="time-letter">Hours</span>
          </div>
          <span className="time-divider">:</span>
          <div className="time-holder">
            <span data-time="minutes" className="time-number">
              25
            </span>
            <span className="time-letter">mins</span>
          </div>
          <span className="time-divider">:</span>
          <div className="time-holder">
            <span data-time="seconds" className="time-number">
              13
            </span>
            <span className="time-letter">secs</span>
          </div>
        </div>
      </div>
    </section>
    <section id="gallery" className="gallery-section">
        ...
        <div className="thumbnails" style={{ display: 'flex', gap: '10px', marginTop: '1rem' }}>
          {galleryImages.map((src, index) => (
            <img
              ...
              style={{
                ...
                height: '80px',
                cursor: 'pointer',
                border: selectedIndex === index ? '3px solid blue' : '1px solid #ccc',
    ...
    <section id="faqs" className="container faqs-section">
      ...
      <details>
        ...
        <p>
          ...
          suscipit repudiandae cupiditate in accusantium recusandae tempora sint
          eligendi, perferendis aspernatur architecto voluptas laborum adipisci
          neque voluptates consequatur.
        </p>
      </details>
      <details>
